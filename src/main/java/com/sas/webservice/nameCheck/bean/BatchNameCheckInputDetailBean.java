...
public class BatchNameCheckInputDetailBean {
	...
	@XmlElement(name = "match_code_entity_name", required = false)
	...
	public BatchNameCheckInputDetailBean(){
		
	}
	
	public BatchNameCheckInputDetailBean(String checkSeq, String entityType, String entityRelationship, String entityRelationshipDesc, String englishName){
	...
	public String getMatchCodeEntityName() {
		return MatchCodeEntityName;
	}

	public void setMatchCodeEntityName(String matchCodeEntityName) {
		MatchCodeEntityName = matchCodeEntityName;
	}
