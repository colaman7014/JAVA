 ...
 */
@Entity
@Table(name="FSC_PARTY_DIM")
@NamedQuery(name="FscPartyDim.findAll", query="SELECT f FROM FscPartyDim f")
public class FscPartyDim implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FscPartyDimPK id;
	...
	public FscPartyDimPK getId() {
		return this.id;
	}

	public void setId(FscPartyDimPK id) {
		this.id = id;
	}
