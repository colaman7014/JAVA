...
/**
 * The persistent class for the INCIDENT_VERSION database table.
 * 
 */
@Entity
@Table(name="INCIDENT_VERSION", schema=SwiftMtConst.COM_SAS_JPACFG_AML_ECM_SCHEMA)
public class IncidentVersion  implements Serializable {
	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	private IncidentVersionPK id;
	...
	public IncidentVersionPK getId() {
		return id;
	}
	public void setId(IncidentVersionPK id) {
		this.id = id;
	}
