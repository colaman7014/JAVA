...
/**
 * The persistent class for the FSC_ENTITY_WATCH_LIST_DIM database table.
 * 
 */
@Entity
@Table(name="FSC_ENTITY_WATCH_LIST_DIM")
@NamedQuery(name="FscEntityWatchListDim.findAll", query="SELECT f FROM FscEntityWatchListDim f")
public class FscEntityWatchListDim implements Serializable {
