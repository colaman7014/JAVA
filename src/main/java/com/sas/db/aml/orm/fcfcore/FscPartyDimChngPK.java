 ...
 */
@Embeddable
public class FscPartyDimChngPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof FscPartyDimChngPK)) {
			return false;
		}
		FscPartyDimChngPK castOther = (FscPartyDimChngPK)other;
		return 
