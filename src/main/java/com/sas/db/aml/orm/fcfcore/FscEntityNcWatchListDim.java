...
/**
 * The persistent class for the FSC_ENTITY_NC_WATCH_LIST_DIM database table.
 * 
 */
@Entity
@Table(name="FSC_ENTITY_NC_WATCH_LIST_DIM")
@NamedQuery(name="FscEntityNcWatchListDim.findAll", query="SELECT f FROM FscEntityNcWatchListDim f")
public class FscEntityNcWatchListDim implements Serializable {
	...
	public FscEntityNcWatchListDim() {
	}
