...
/**
 * The persistent class for the FSC_BANK_NC_WATCH_LIST_DIM database table.
 * 
 */
@Entity
@Table(name="FSC_BANK_NC_WATCH_LIST_DIM")
@NamedQuery(name="FscBankNcWatchListDim.findAll", query="SELECT f FROM FscBankNcWatchListDim f")
public class FscBankNcWatchListDim implements Serializable {
