 ...
 */
@Entity
@Table(name="FSC_PARTY_DIM_WLF")
@NamedQuery(name="FscPartyDimWlf.findAll", query="SELECT f FROM FscPartyDimWlf f")
@DynamicUpdate
public class FscPartyDimWlf implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private FscPartyDimWlfPK id;
	...
	@Column(name="wlf_flg")
	private String wlfFlg;

	
	public FscPartyDimWlf() {
	}

	public FscPartyDimWlfPK getId() {
		return this.id;
	}

	public void setId(FscPartyDimWlfPK id) {
		this.id = id;
	}
	...
	public String getWlfFlg() {
		return wlfFlg;
	}

	public void setWlfFlg(String wlfFlg) {
		this.wlfFlg = wlfFlg;
	}
