...
/**
 * The persistent class for the FSC_BANK_WATCH_LIST_DIM database table.
 * 
 */
@Entity
@Table(name="FSC_BANK_WATCH_LIST_DIM")
@NamedQuery(name="FscBankWatchListDim.findAll", query="SELECT f FROM FscBankWatchListDim f")
public class FscBankWatchListDim implements Serializable {
