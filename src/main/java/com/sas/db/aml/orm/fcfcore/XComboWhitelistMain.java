...
/**
 * The persistent class for the X_COMBO_WHITELIST_MAIN database table.
 * 
 */
@Entity
@Table(name="X_COMBO_WHITELIST_MAIN")
@NamedQuery(name="XComboWhitelistMain.findAll", query="SELECT x FROM XComboWhitelistMain x")
public class XComboWhitelistMain implements Serializable {
