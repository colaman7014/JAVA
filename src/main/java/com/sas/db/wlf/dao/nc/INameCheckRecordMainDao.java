...
public interface INameCheckRecordMainDao extends CrudRepository<NameCheckRecordMain, NameCheckRecordMainPK>, iNameCheckRecordMainDaoCoustom{
	...
	List<NameCheckRecordMain> findByTransactionDateBetweenAndInterfaceNameAndNcResultAndCaseRkIs(Date fromDate, Date endDate, String ncResult, String interfaceName, long caseRk);
}
