...
/**
 * The persistent class for the SWIFT_MT791 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT791", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt791.findAll", query="SELECT s FROM SwiftMt791 s")
public class SwiftMt791 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt791PK id;
	...
	public SwiftMt791PK getId() {
		return this.id;
	}

	public void setId(SwiftMt791PK id) {
		this.id = id;
	}
