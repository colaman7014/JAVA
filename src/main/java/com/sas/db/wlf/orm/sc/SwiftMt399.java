...
/**
 * The persistent class for the SWIFT_MT399 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT399", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt399.findAll", query="SELECT s FROM SwiftMt399 s")
public class SwiftMt399 implements Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt399PK id;
	...
	public SwiftMt399PK getId() {
		return this.id;
	}

	public void setId(SwiftMt399PK id) {
		this.id = id;
	}
