...
/**
 * The persistent class for the SWIFT_MT795 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT795", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt795.findAll", query="SELECT s FROM SwiftMt795 s")
public class SwiftMt795 implements Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt795PK id;
	...
	public SwiftMt795PK getId() {
		return this.id;
	}

	public void setId(SwiftMt795PK id) {
		this.id = id;
	}
