...
/**
 * The persistent class for the SWIFT_MT202COV database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT202COV", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt202COV.findAll", query="SELECT s FROM SwiftMt202COV s")
public class SwiftMt202COV implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt202COVPK id;
	...
	public SwiftMt202COV() {
	}

	public SwiftMt202COVPK getId() {
		return this.id;
	}

	public void setId(SwiftMt202COVPK id) {
		this.id = id;
	}
