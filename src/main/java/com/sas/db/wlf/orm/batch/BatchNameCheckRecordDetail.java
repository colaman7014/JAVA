 ...
 */
@Entity
@Table(name="BATCH_NAME_CHECK_RECORD_DETAIL")
@NamedQuery(name="BatchNameCheckRecordDetail.findAll", query="SELECT n FROM BatchNameCheckRecordDetail n")
public class BatchNameCheckRecordDetail implements Serializable {

	@EmbeddedId
	private BatchNameCheckRecordDetailPK id;
	...
	public BatchNameCheckRecordDetail() {
	}

	public BatchNameCheckRecordDetailPK getId() {
		return id;
	}

	public void setId(BatchNameCheckRecordDetailPK id) {
		this.id = id;
	}
