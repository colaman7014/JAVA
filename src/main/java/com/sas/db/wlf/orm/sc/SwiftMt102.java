...
/**
 * The persistent class for the SWIFT_MT102 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT102", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt102.findAll", query="SELECT s FROM SwiftMt102 s")
public class SwiftMt102 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt102PK id;
	...
	public SwiftMt102PK getId() {
		return this.id;
	}

	public void setId(SwiftMt102PK id) {
		this.id = id;
	}
