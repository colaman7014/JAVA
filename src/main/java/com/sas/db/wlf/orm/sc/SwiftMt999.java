...
/**
 * The persistent class for the SWIFT_MT999 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT999", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt999.findAll", query="SELECT s FROM SwiftMt999 s")
public class SwiftMt999 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt999PK id;
	...
	public SwiftMt999PK getId() {
		return this.id;
	}

	public void setId(SwiftMt999PK id) {
		this.id = id;
	}
