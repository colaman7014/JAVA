...
/**
 * The persistent class for the SWIFT_MT590 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT590", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt590.findAll", query="SELECT s FROM SwiftMt590 s")
public class SwiftMt590 implements Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt590PK id;
	...
	public SwiftMt590PK getId() {
		return this.id;
	}

	public void setId(SwiftMt590PK id) {
		this.id = id;
	}
