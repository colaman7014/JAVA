...
/**
 * The persistent class for the SWIFT_MT711 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT711", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt711.findAll", query="SELECT s FROM SwiftMt711 s")
public class SwiftMt711 implements Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt711PK id;
	...
	public SwiftMt711PK getId() {
		return this.id;
	}

	public void setId(SwiftMt711PK id) {
		this.id = id;
	}
