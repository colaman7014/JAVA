...
/**
 * The persistent class for the SWIFT_MT104 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT104", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt104.findAll", query="SELECT s FROM SwiftMt104 s")
public class SwiftMt104 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt104PK id;
	...
	public SwiftMt104PK getId() {
		return this.id;
	}

	public void setId(SwiftMt104PK id) {
		this.id = id;
	}
