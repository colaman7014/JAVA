...
/**
 * The persistent class for the SWIFT_MT543 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT543", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt543.findAll", query="SELECT s FROM SwiftMt543 s")
public class SwiftMt543 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt543PK id;
	...
	public SwiftMt543PK getId() {
		return this.id;
	}

	public void setId(SwiftMt543PK id) {
		this.id = id;
	}
