...
/**
 * The persistent class for the SWIFT_MT605 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT605", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt605.findAll", query="SELECT s FROM SwiftMt605 s")
public class SwiftMt605 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt605PK id;
	...
	public SwiftMt605PK getId() {
		return this.id;
	}

	public void setId(SwiftMt605PK id) {
		this.id = id;
	}
