...
/**
 * The persistent class for the SWIFT_MT192 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT192", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt192.findAll", query="SELECT s FROM SwiftMt192 s")
public class SwiftMt192 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt192PK id;
	...
	public SwiftMt192PK getId() {
		return this.id;
	}

	public void setId(SwiftMt192PK id) {
		this.id = id;
	}
