...
/**
 * The persistent class for the SWIFT_MT295 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT295", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt295.findAll", query="SELECT s FROM SwiftMt295 s")
public class SwiftMt295 implements Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt295PK id;
	...
	public SwiftMt295PK getId() {
		return this.id;
	}

	public void setId(SwiftMt295PK id) {
		this.id = id;
	}
