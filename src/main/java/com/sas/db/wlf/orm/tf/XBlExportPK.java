...
/**
 * The primary key class for the X_BL_EXPORT database table.
 * 
 */
@Embeddable
public class XBlExportPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof XBlExportPK)) {
			return false;
		}
		XBlExportPK castOther = (XBlExportPK)other;
		return 
