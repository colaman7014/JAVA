...
/**
 * The persistent class for the SWIFT_MT196 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT196", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt196.findAll", query="SELECT s FROM SwiftMt196 s")
public class SwiftMt196 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt196PK id;
	...
	public SwiftMt196PK getId() {
		return this.id;
	}

	public void setId(SwiftMt196PK id) {
		this.id = id;
	}
	...
	public String getNarrative_Description_of_the_Original_Message_to_Which_the_Answer_Relates() {
		return this.narrative_Description_of_the_Original_Message_to_Which_the_Answer_Relates;
	}

	public void setNarrative_Description_of_the_Original_Message_to_Which_the_Answer_Relates(String narrative_Description_of_the_Original) {
		this.narrative_Description_of_the_Original_Message_to_Which_the_Answer_Relates = narrative_Description_of_the_Original;
	}
