...
/**
 * The persistent class for the SWIFT_MT198 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT198", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt198.findAll", query="SELECT s FROM SwiftMt198 s")
public class SwiftMt198 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt198PK id;
	...
	public SwiftMt198PK getId() {
		return this.id;
	}

	public void setId(SwiftMt198PK id) {
		this.id = id;
	}
