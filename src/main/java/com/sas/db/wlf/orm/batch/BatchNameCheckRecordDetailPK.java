...
/**
 * The primary key class for the BATCH_NAME_CHECK_RECORD_DETAIL database table.
 * 
 */
@Embeddable
public class BatchNameCheckRecordDetailPK implements Serializable {
	...
	public BatchNameCheckRecordDetailPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof BatchNameCheckRecordDetailPK)) {
			return false;
		}
		BatchNameCheckRecordDetailPK castOther = (BatchNameCheckRecordDetailPK)other;
		return 
