...
/**
 * The persistent class for the SWIFT_MT540 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT540", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt540.findAll", query="SELECT s FROM SwiftMt540 s")
public class SwiftMt540 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt540PK id;
	...
	public SwiftMt540PK getId() {
		return this.id;
	}

	public void setId(SwiftMt540PK id) {
		this.id = id;
	}
