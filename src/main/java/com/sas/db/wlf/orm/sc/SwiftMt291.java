...
/**
 * The persistent class for the SWIFT_MT291 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT291", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt291.findAll", query="SELECT s FROM SwiftMt291 s")
public class SwiftMt291 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt291PK id;
	...
	public SwiftMt291PK getId() {
		return this.id;
	}

	public void setId(SwiftMt291PK id) {
		this.id = id;
	}
