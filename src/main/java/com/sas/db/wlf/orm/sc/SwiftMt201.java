...
/**
 * The persistent class for the SWIFT_MT201 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT201", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt201.findAll", query="SELECT s FROM SwiftMt201 s")
public class SwiftMt201 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt201PK id;
	...
	public SwiftMt201PK getId() {
		return this.id;
	}

	public void setId(SwiftMt201PK id) {
		this.id = id;
	}
