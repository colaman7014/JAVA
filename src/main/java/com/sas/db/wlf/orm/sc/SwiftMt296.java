...
/**
 * The persistent class for the SWIFT_MT296 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT296", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt296.findAll", query="SELECT s FROM SwiftMt296 s")
public class SwiftMt296 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt296PK id;
	...
	public SwiftMt296PK getId() {
		return this.id;
	}

	public void setId(SwiftMt296PK id) {
		this.id = id;
	}
	...
	public void setNarrative_Description_of_the_Original_Message_to_Which_the_Answer_Relates(String narrative_Description_of_the) {
		this.narrative_Description_of_the_Original_Message_to_Which_the_Answer_Relates = narrative_Description_of_the;
	}
