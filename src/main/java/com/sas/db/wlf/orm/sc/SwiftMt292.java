...
/**
 * The persistent class for the SWIFT_MT292 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT292", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt292.findAll", query="SELECT s FROM SwiftMt292 s")
public class SwiftMt292 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt292PK id;
	...
	public SwiftMt292PK getId() {
		return this.id;
	}

	public void setId(SwiftMt292PK id) {
		this.id = id;
	}
