...
/**
 * The persistent class for the SWIFT_MT290 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT290", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt290.findAll", query="SELECT s FROM SwiftMt290 s")
public class SwiftMt290 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt290PK id;
	...
	public SwiftMt290PK getId() {
		return this.id;
	}

	public void setId(SwiftMt290PK id) {
		this.id = id;
	}
