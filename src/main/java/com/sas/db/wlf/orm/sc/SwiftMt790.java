...
/**
 * The persistent class for the SWIFT_MT790 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT790", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt790.findAll", query="SELECT s FROM SwiftMt790 s")
public class SwiftMt790 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt790PK id;
	...
	public SwiftMt790PK getId() {
		return this.id;
	}

	public void setId(SwiftMt790PK id) {
		this.id = id;
	}
