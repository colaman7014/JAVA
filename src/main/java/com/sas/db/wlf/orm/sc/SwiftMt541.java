...
/**
 * The persistent class for the SWIFT_MT541 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT541", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt541.findAll", query="SELECT s FROM SwiftMt541 s")
public class SwiftMt541 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt541PK id;
	...
	public SwiftMt541PK getId() {
		return this.id;
	}

	public void setId(SwiftMt541PK id) {
		this.id = id;
	}
