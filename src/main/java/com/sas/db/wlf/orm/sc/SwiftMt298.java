...
/**
 * The persistent class for the SWIFT_MT298 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT298", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt298.findAll", query="SELECT s FROM SwiftMt298 s")
public class SwiftMt298 implements Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt298PK id;
	...
	public SwiftMt298PK getId() {
		return this.id;
	}

	public void setId(SwiftMt298PK id) {
		this.id = id;
	}
