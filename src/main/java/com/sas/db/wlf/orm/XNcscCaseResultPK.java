...
/**
 * The primary key class for the X_NCSC_CASE_RESULT database table.
 * 
 */
@Embeddable
public class XNcscCaseResultPK implements Serializable {
	...
	public XNcscCaseResultPK() {
	}
	
	public XNcscCaseResultPK(XNcscCaseResultTmpPK resultTmpPK) {
		this.caseRk = resultTmpPK.getCaseRk();
		this.ncReferenceId = resultTmpPK.getNcReferenceId();
		this.seq = resultTmpPK.getSeq();
		this.uniqueKey = resultTmpPK.getUniqueKey();
		this.rowNo = resultTmpPK.getRowNo();
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof XNcscCaseResultPK)) {
			return false;
		}
		XNcscCaseResultPK castOther = (XNcscCaseResultPK)other;
		return 
