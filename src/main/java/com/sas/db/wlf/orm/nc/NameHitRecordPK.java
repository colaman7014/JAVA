 ...
 */
@Embeddable
public class NameHitRecordPK implements Serializable {
	...
	public NameHitRecordPK() {
	}
	public NameHitRecordPK(String uniqueKey, int ncReferenceId, String checkSeq, String seq){
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof NameHitRecordPK)) {
			return false;
		}
		NameHitRecordPK castOther = (NameHitRecordPK)other;
		return 
