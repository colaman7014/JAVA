...
/**
 * The persistent class for the SWIFT_MT899 database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT899", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt899.findAll", query="SELECT s FROM SwiftMt899 s")
public class SwiftMt899 implements Serializable{
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt899PK id;
	...
	public SwiftMt899PK getId() {
		return this.id;
	}

	public void setId(SwiftMt899PK id) {
		this.id = id;
	}
