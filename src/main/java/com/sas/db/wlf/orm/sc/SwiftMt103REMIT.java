...
/**
 * The persistent class for the SWIFT_MT103_REMIT database table.
 * 
 */
@Entity
@Table(name="SWIFT_MT103REMIT", schema=SwiftMtConst.COM_SAS_JPACFG_NCSC_SCHEMA)
@NamedQuery(name="SwiftMt103REMIT.findAll", query="SELECT s FROM SwiftMt103REMIT s")
public class SwiftMt103REMIT implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private SwiftMt103REMITPK id;
	...
	public SwiftMt103REMIT() {
	}

	public SwiftMt103REMITPK getId() {
		return this.id;
	}

	public void setId(SwiftMt103REMITPK id) {
		this.id = id;
	}
