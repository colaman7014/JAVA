	...
	public Map<String, MatchCodeResultBean> datafluxMatchCode(String sensitivity, String non_english_name, String english_name) {
		...
		try {
			...
			for(int i=0;i<tableOutList.getRow().size();i++){
				...
				//logger.error("rowInBean.getChName()="+rowInBean.getChName() + "  cnMatchCodeResult.ind"+cnMatchCodeResult.getMatchcodeInd() + "  cnMatchCodeResult.org"+cnMatchCodeResult.getMatchcodeOrg());
