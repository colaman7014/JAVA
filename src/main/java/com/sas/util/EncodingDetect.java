...
//        String file = "D://NC_GEID_1070613001_20180608.d"; 
//        String encode = "";
//		try {
...
//    } 
     ...
     * @return �ɮת��s�X 
     */ 
    public static String getJavaEncode(File file) throws Exception{ 
...
class BytesEncodingDetect extends Encoding { 
    ...
    public int detectEncoding(byte[] rawtext) {
        Integer big5WeightScore = Integer.valueOf(AmlConfiguration.getString(SwiftMtConst.COM_SAS_CHARSET_DETECHED_BIG5_WEIGHT_SCORE));
        Integer unicodeWeightScore = Integer.valueOf(AmlConfiguration.getString(SwiftMtConst.COM_SAS_CHARSET_DETECHED_UNICODE_WEIGHT_SCORE));
        int[] scores; 
        ...
        scores[BIG5] = big5_probability(rawtext) + big5WeightScore;
        scores[CNS11643] = euc_tw_probability(rawtext); 
        scores[ISO2022CN] = iso_2022_cn_probability(rawtext); 
        scores[UTF8] = utf8_probability(rawtext) + unicodeWeightScore;
        scores[UNICODE] = utf16_probability(rawtext) + unicodeWeightScore;
...
class Encoding { 
    ...
    // Constructor   
    public Encoding() {
        String javaDeafultDecode = AmlConfiguration.getString(SwiftMtConst.COM_SAS_CHARSET_DETECHED_DEAFULT_DECODE);
        ...
        javaname[OTHER] = javaDeafultDecode;
        // Assign encoding names   
