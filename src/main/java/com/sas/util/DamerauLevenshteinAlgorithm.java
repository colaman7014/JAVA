...
public class DamerauLevenshteinAlgorithm {
  ...
  public static void main(String[] args){
	  DamerauLevenshteinAlgorithm dla=new DamerauLevenshteinAlgorithm(2,2,2,2);
	 // new DamerauLevenshteinAlgorithm(2,2,2,2).execute(source, target);
	  System.out.println(dla.execute("aaabbb", "bbbaaa"));
  }
}